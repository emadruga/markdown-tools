...
A CLI tool that converts markdown files to PDF format.
The PDF is saved in the same directory as the input file.
        ...
        try:
            pypandoc.convert_file(
                ...
                extra_args=[
                    ...
                    '--variable', 'mainfont=Menlo',  # macOS font with Unicode support
                    '--variable', 'monofont=Menlo',  # Monospace font for code/diagrams
            ...
            if "pandoc" in str(e).lower() or "pdflatex" in str(e).lower():
                raise RuntimeError(
                    "pandoc or pdflatex is not installed or not found in PATH.\n"
                    "Install pandoc:\n"
                    "  - macOS: brew install pandoc basictex\n"
                    "  - Linux: sudo apt-get install pandoc texlive-latex-base\n"
                    "  - Windows: choco install pandoc miktex\n"
